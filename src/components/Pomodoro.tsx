        ...
        <div className="max-w-4xl w-full flex flex-col items-center">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            >
              ...
              <span className="text-[10px] font-mono uppercase tracking-widest text-zinc-400">Focus_Session</span>
            </motion.div>
            ...
            <motion.div 
              ...
              className="text-[9rem] md:text-[12rem] font-bold tracking-tighter tabular-nums text-white leading-none cursor-pointer hover:text-[#F27D26] transition-colors group relative"
            >
            ...
            <div className="flex items-center gap-6 mt-12">
              <button 
                onClick={toggleTimer}
                className={`w-24 h-24 rounded-full flex items-center justify-center transition-all hover:scale-105 active:scale-95 ${isRunning ? 'bg-white/5 border border-white/20 text-white' : 'bg-[#F27D26] text-black shadow-[0_0_50px_rgba(242,125,38,0.3)]'}`}
              >
